...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|_app| {
            ...
            // Note: Transcription engines will be initialized lazily when needed
            // This prevents loading heavy models unnecessarily for cloud providers
            log::info!("Transcription engines will be initialized on first use (lazy loading)");
